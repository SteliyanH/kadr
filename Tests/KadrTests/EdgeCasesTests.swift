...
struct EdgeCasesTests {
    ...
    @Test(.enabled(if: TestEnvironment.canDecodeMedia)) func speedAndReversedCombined() async throws {
        let videoURL = try loadTestVideoURL()
    ...
    @Test(.enabled(if: TestEnvironment.canDecodeMedia)) func multipleBackgroundTracksWithDucking() async throws {
        let videoURL = try loadTestVideoURL()
