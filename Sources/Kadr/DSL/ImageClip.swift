...
public struct ImageClip: Clip, Sendable {
    ...
    internal init(image: PlatformImage, duration: CMTime, backgroundColor: PlatformColor?, audioURL: URL?, clipID: ClipID? = nil, startTime: CMTime? = nil) {
        self.image = image
        self._duration = duration
    ...
    public func background(_ color: PlatformColor) -> ImageClip {
        ImageClip(image: image, duration: _duration, backgroundColor: color, audioURL: audioURL, clipID: clipID, startTime: startTime)
    }
    ...
    public func withAudio(_ audioURL: URL) -> ImageClip {
        ImageClip(image: image, duration: _duration, backgroundColor: backgroundColor, audioURL: audioURL, clipID: clipID, startTime: startTime)
    }

    /// Override the duration with a `CMTime` for frame-accurate precision.
    public func duration(_ duration: CMTime) -> ImageClip {
        ImageClip(image: image, duration: duration, backgroundColor: backgroundColor, audioURL: audioURL, clipID: clipID, startTime: startTime)
    }
    ...
    public func id(_ id: ClipID) -> ImageClip {
        ImageClip(image: image, duration: _duration, backgroundColor: backgroundColor, audioURL: audioURL, clipID: id, startTime: startTime)
    }
    ...
    public func at(time: CMTime) -> ImageClip {
        ImageClip(image: image, duration: _duration, backgroundColor: backgroundColor, audioURL: audioURL, clipID: clipID, startTime: time)
    }
